...
class GratuityEndofService(AccountsController):
	def validate(self):
	...
	def calculate_work_experience_and_amount(self):
		...
		# تحويل عدد الأيام إلى عدد السنين
		self.current_work_experience_years = employee_total_workings_days // rule.total_working_days_per_year 
...
def get_work_experience_using_method(
	...
	elif method == "Take Exact Completed Years":
		current_work_experience = floor(current_work_experience)
	else:
		current_work_experience = flt(current_work_experience)
